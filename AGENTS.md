...
For frontend types, if types depend on server api data, always pick the types form the generated api in `types.gen.ts` where possible to avoid redefinitions. This file can be regenerated with `yarn gen-api` at the top level directory.
