...
- [x] Rule 1: no constructor
- [x] Rule 4: `tasks.controller.ts:162` — `migrateResponseSnapshots`
...
- [x] Rule 1: no constructor
- [x] Rule 4: `tasks.controller.ts:249` — `customValidators`
...
- [x] Rule 1: no constructor
- [x] Rule 4: `tasks.controller.ts:283` — `createCustomValidator`
...
- [x] Rule 1: no constructor
- [x] Rule 4: `videos.controller.ts:72` — `listVideos` returns object literal `{ videos }`
...
- [x] Rule 1: no constructor
- [x] Rule 4: `videos.controller.ts:115` — `getVideoDetails` returns object literal
