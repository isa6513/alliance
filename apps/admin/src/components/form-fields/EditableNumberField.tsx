import type { NumberField } from "@alliance/shared/lib/formschema";
import type { BaseFieldProps } from "./types";
import { FieldWrapper } from "./FieldWrapper";

export function EditableNumberField({ field, onUpdate, onRemove, onDragStart, onDragEnd, isDragging }: BaseFieldProps<NumberField<string>>) {
  return (
