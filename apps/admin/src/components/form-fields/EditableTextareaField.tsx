import type { TextareaField } from "@alliance/shared/lib/formschema";
import type { BaseFieldProps } from "./types";
import { FieldWrapper } from "./FieldWrapper";

export function EditableTextareaField({ field, onUpdate, onRemove, onDragStart, onDragEnd, isDragging }: BaseFieldProps<TextareaField<string>>) {
  return (
