import type { DividerBlock } from "@alliance/shared/lib/display-blocks";
import type { BaseDisplayBlockProps } from "./types";
import { DisplayBlockWrapper } from "./DisplayBlockWrapper";

export function EditableDividerBlock({ block, onUpdate, onRemove, onDragStart, onDragEnd, isDragging }: BaseDisplayBlockProps<DividerBlock<string>>) {
  return (
      ...
      <div className="space-y-2">
        ...
        <div className="flex items-center gap-2">
          ...
          <select
            ...
            onChange={(e) => onUpdate({ thickness: e.target.value as "hairline" | "thin" | "medium" | "thick" })}
