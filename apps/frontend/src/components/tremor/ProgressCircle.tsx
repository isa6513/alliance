...
const progressCircleVariants = tv({
  ...
  variants: {
    variant: {
      ...
      neutral: {
        background: "stroke-gray-900/10 dark:stroke-gray-500/40",
        circle: "stroke-gray-500 dark:stroke-gray-500",
      },
      warning: {
        background: "stroke-gray-900/10 dark:stroke-yellow-500/30",
      ...
      success: {
        background: "stroke-gray-900/10 dark:stroke-emerald-500/30",
