          ...
          <div className="flex flex-col gap-y-4 max-w-184 w-full min-w-0">
            ...
            <div className="flex flex-col gap-y-12">
              <GuideSection id="overview">
                ...
                <GuideP>
                  Hundreds of millions of people are worried about the state of
                  our world. Many recognize a need for decisive action, but do
                  not know what to do.
                </GuideP>
                <GuideP>
                  The Alliance wants to provide a clear answer. We believe
                ...
                <GuideP>
                  ...
                  behind an{" "}
                  <GuideStrong>
                    expert-guided, democratically approved
                  </GuideStrong>{" "}
                  plan. This plan will strategically direct members&apos;
                  collective economic, political, and social resources in order
                  to make rapid progress on humanity&apos;s most pressing global
                  crises.
                </GuideP>
                <GuideP>
                  We plan to{" "}
                  ...
                  to break down this plan into tasks, and assign them to members
                  of the Alliance. Members are expected to{" "}
                ...
                <GuideP>
                  ...
                  force — one that, for instance, could enable massive targeted
                  boycotts, voluntary reductions of excessive consumption,
                  common knowledge of topics of choice, and funding for
                  neglected scientific research.
                </GuideP>
              </GuideSection>
              ...
              <GuideSection id="priorities">
                ...
                <GuideP>
                  The Alliance is oriented around solving specific problems, not
                  around an ideology. We believe this will help us build a large
                  and diverse coalition, as well as focus on the empirical
                  effectiveness, rather than the type, of our methods.
                </GuideP>
              ...
              <GuideSection id="structure">
                ...
                <GuideUl>
                  ...
                  <GuideLi>
                    ...
                    have a discernable total impact.
                  </GuideLi>
                  <GuideLi>
                    Negotiate agreements with third parties, such as
                    corporations, backed by credible incentives (such as a bulk
                    purchase or promise of boycott).
                  </GuideLi>
                </GuideUl>
                <GuideP>
                  We formalize expectations with a simple{" "}
                  <GuideStrong>contract</GuideStrong> that members sign to join
                  the Alliance. Right now, we have one contract available that
                  asks members to complete 15 minutes of tasks per week. Over
                  time, we may offer differentiated contracts; for example,
                  tailored to profession or disposable income.
                </GuideP>
                ...
                <GuideP>
                  ...
                  contributing equally, which encourages each member to do their
                  part.
                </GuideP>
                <GuideP>
                  If a member does not regularly complete the tasks they are
                  assigned, we automatically suspend their contract, allowing us
                  to maintain collective expectations.
                </GuideP>

                <GuideH2 id="office">Office</GuideH2>
                <GuideP>
                  The office maintains a global plan for the Alliance and breaks
                  it down into tasks for members to complete. Our goal is to
                  build a department of experts and strategists who run a
                  fast-paced, robust process to develop and evaluate actions.
                </GuideP>

                <GuideP>
                  Each action will be unique. However, templates include raising
                  funds, changing consumer behavior, concentrating social
                  pressure, educating members, and coordinating political
                  activity. Some tasks will be collective or highly coordinated
                  with other tasks; others will be assigned to specific
                  individuals based on their capacities, such as an ability to
                  influence a specific sector or vote in a specific region.
                </GuideP>
                <GuideP>
                  Every action will be associated with a justification
                  explaining how it is expected to produce a tangible outcome,
                  such as a change in a corporation&apos;s policy or validation
                ...
                <GuideP>
                  ...
                  confidence that each action is a worthwhile use of their time,
                  not just performative. The public trusts{" "}
                  <Link
                ...
                <GuideP>
                  To be effective and in order to scale, we will need to combine
                  expert-driven strategy with local knowledge, and strike a
                  balance between centralization and decentralization. We
                  imagine that many actions will be proposed by members or
                  people in their communities, with experts in an evaluative and
                  supporting role.
                </GuideP>
              </GuideSection>
              ...
              <GuideSection id="governance">
                ...
                <GuideP>
                  ...
                  solicit feedback from members as well as provide members with
                  pertinent information.
                </GuideP>
                <GuideP>
                  In addition, disagreeing members will have several options for
                  formal recourse, including:
                </GuideP>
                <GuideUl>
                ...
                <GuideP>
                  ...
                  members. Members who substantially disapprove of the Alliance
                  can easily leave.
                </GuideP>
                ...
                <GuideP>
                  ...
                  adjusting course if approval falls beneath some threshold. For
                  now, the Alliance runs an oversight process every 6 months
                  that consists of a single question:
                </GuideP>
                ...
                <GuideP>
                  We guarantee that members will only ever have to take actions
                  they think are moral by providing an option to withdraw from
                  tasks they believe are immoral. Therefore, the office will
                  only be able to expect participation in an action inasmuch as
                  members believe the action is moral.
                </GuideP>
              </GuideSection>
              ...
              <GuideSection id="culture">
                ...
                <GuideUl>
                  ...
                  <GuideLi>
                    <GuideStrong>Rigor</GuideStrong> in evaluating the costs and
                    benefits of our actions, so that we retain trust and
                    effectiveness.
                  </GuideLi>
                  <GuideLi>
                    <GuideStrong>Outcomes</GuideStrong> over unanimous agreement
                    or perfect fairness, so that we can act with appropriate
                    urgency.
                  </GuideLi>
                  <GuideLi>
              ...
              <GuideSection id="online-platform">
                ...
                <GuideP>
                  ...
                  experience on the platform. With thoughtful design, immersive
                  progress updates, and social features co-developed with
                  members, we want to create an environment in which members are
                  eager for what&apos;s next, proud of what they&apos;ve
                  achieved, and connected to community.
                </GuideP>
              </GuideSection>
              ...
              <GuideSection id="roadmap">
                ...
                <GuideUl>
                  ...
                  <GuideLi>
                    Build a group of thousands of experts who will provide a set
                    of coordinated public endorsements.
                  </GuideLi>
                  <GuideLi>
                ...
                <GuideP>
                  After we launch publicly, we hope to achieve regular, visible
                  successes that inspire more and increasingly diverse people
                  around the world to join us. We cannot yet describe the
                  precise actions that we will take as we grow, as this will
                  require both expert involvement and learned experience, but we
                  can provide illustrative examples.
                </GuideP>
                <GuideP>
                  <GuideStrong>With 1K-1M members</GuideStrong>, we will focus
                  on small tasks with clear wins to build momentum. For example,
                  we could:
                </GuideP>
                <GuideUl>
                  <GuideLi>
                    Fund land acquisitions for conservation or lift villages out
                    of poverty.
                  </GuideLi>
                  <GuideLi>
                ...
                <GuideUl>
                  ...
                  <GuideLi>
                    Help members transition simultaneously to independent media
                    and social media companies.
                  </GuideLi>
                  <GuideLi>Run immense citizen science projects.</GuideLi>
                  <GuideLi>
                    Host global deliberations on topics such as AI governance
                    and solar radiation management to spur social awareness and
                    political demand.
                  </GuideLi>
                </GuideUl>
                <GuideP>
                ...
                <GuideUl>
                  ...
                  <GuideLi>
                    ...
                    education and deliberation to generate political demand for
                    them.
                  </GuideLi>
                  <GuideLi>
                    Run an enormous campaign to elect cooperative world leaders
                ...
                <GuideP>
                  ...
                  behavior, influencing national and international politics, and
                  more.
                </GuideP>
              </GuideSection>
            </div>
