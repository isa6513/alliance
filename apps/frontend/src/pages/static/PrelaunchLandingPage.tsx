...
function PreviewActionCard({ action }: { action: ActionDto }) {
  return (
    <Link
      ...
      className="group relative flex flex-row items-start justify-between gap-4 rounded-lg border border-zinc-200  p-4 lg:p-6 hover:bg-zinc-50"
    >
  ...
  return (
    <div className="min-h-screen lg:h-screen flex flex-col bg-white">
      ...
      <div className="flex-1 flex flex-col mx-auto gap-y-8 lg:gap-y-16 py-8 lg:pt-20 lg:pb-36 px-8">
        ...
        <div className="flex flex-col items-center gap-y-4 lg:max-w-[1000px]">
          <img
            src={alliancePeople}
