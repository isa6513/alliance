...
export const LANDING_MAIN_COL =
  "mx-auto w-full max-w-6xl px-4 sm:px-10 lg:px-16";
/** Wider column for hero + quote cards so they use more of the viewport. */
export const LANDING_QUOTES_COL =
  "mx-auto w-full max-w-7xl px-4 sm:px-6 lg:max-w-[100rem] lg:px-10";

export const LANDING_SECTION_GAP = "flex flex-col gap-y-6 lg:gap-y-12";
...
export const LANDING_SECTION_PB = "pb-12 md:pb-16 lg:pb-24";
export const LANDING_SECTION_PY = "py-12 md:py-16 lg:py-24";

export const SECTION_TITLE_CLASS =
  "text-title-large text-center w-full text-black";
export const SUBTITLE_CLASS = "text-xl text-center text-zinc-900 lg:text-2xl";
