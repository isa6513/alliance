...
export class AddUserAwayRange1762213867340 implements MigrationInterface {
  name = 'AddUserAwayRange1762213867340';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
        ...
        `);
    await queryRunner.query(
      `CREATE INDEX "IDX_user_away_range_userId" ON "user_away_range" ("userId")`,
    );
  }
