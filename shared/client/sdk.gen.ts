...
export const actionsMyActionRelations = <ThrowOnError extends boolean = false>(options?: Options<ActionsMyActionRelationsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<ActionsMyActionRelationsResponse, unknown, ThrowOnError>({
...
export const paymentsPaymentMethods = <ThrowOnError extends boolean = false>(options?: Options<PaymentsPaymentMethodsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<PaymentsPaymentMethodsResponse, unknown, ThrowOnError>({
