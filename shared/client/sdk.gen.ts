 ...
 * Delete a reply
 */
export const forumDeleteReply = <ThrowOnError extends boolean = false>(options: Options<ForumDeleteReplyData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<unknown, unknown, ThrowOnError>({
